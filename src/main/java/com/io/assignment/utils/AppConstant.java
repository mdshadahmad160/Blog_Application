package com.io.assignment.utils;
...
public class AppConstant {
    ...
    public static final String TAG_ID_EXIST = "This id is already exist in database (recommend not to pass id in json )";
    ...
    public static final String CATEGORY_DELETE_MESSAGE = "Successfully delete this category";
    public static final String COMMENT_DELETE_MESSAGE = "Successfully delete this comment";
    public static final String TAG_DELETE_MESSAGE = "Successfully delete this tag";
    public static final String BLOG_DELETE_MESSAGE = "Successfully delete this blog";
    public static final String USER_DELETE_MESSAGE = "Successfully delete this user";
    ...
    public static final String GIVE_ADMIN = "Give admin successfully";
    public static final String TAKE_ADMIN = "Take admin successfully";
}
